...
var CustomEvent = {
    ...
    gId: 0,
    // 处理自定义事件的名称
    eventPrefixArgs: function eventPrefixArgs(args, prefix) {
        var data = args;
        if (data.length > 1) {
            data = data.slice(1);
        }
    ...
    mix: function mix(srcObj, targetObj) {
        (0, _keys2.default)(targetObj).forEach(function (key) {
...
var innerEvent = {
    ...
    off: function off(name, handler) {
        ...
        var handlers = CustomEvent.events[name];
    ...
    fire: function fire(name) {
        ...
        handlers.forEach(function (item) {
            item.apply(undefined, (0, _toConsumableArray3.default)(args));
        });
    },
    isFired: function isFired(name) {
...
var normalEvent = {};
(0, _keys2.default)(CustomEvent.innerEvent).forEach(function (item) {
    normalEvent[item] = function () {
        var _CustomEvent$innerEve;

        for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
            args[_key2] = arguments[_key2];
        }

        return (_CustomEvent$innerEve = CustomEvent.innerEvent)[item].apply(_CustomEvent$innerEve, (0, _toConsumableArray3.default)(CustomEvent.eventPrefixArgs(args, 'normalevent')));
    };
});
...
function Event(target) {
    ...
    var evId = target._eventId;

    (0, _keys2.default)(CustomEvent.innerEvent).forEach(function (item) {
        evObj[item] = function () {
            var _CustomEvent$innerEve2;

            for (var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
                args[_key3] = arguments[_key3];
            }

            return (_CustomEvent$innerEve2 = CustomEvent.innerEvent)[item].apply(_CustomEvent$innerEve2, (0, _toConsumableArray3.default)(CustomEvent.eventPrefixArgs(args, 'objectevent_' + evId)));
        };
    });
...
var InputController = function () {
    function InputController(model) {
        (0, _classCallCheck3.default)(this, InputController);

        this.model = model;
    }

    (0, _createClass3.default)(InputController, [{
        key: "onAddNewTodo",
        value: function onAddNewTodo(content) {
...
var TodoListController = function () {
    function TodoListController(model) {
        (0, _classCallCheck3.default)(this, TodoListController);

        this.model = model;
    }

    (0, _createClass3.default)(TodoListController, [{
        key: "onCheck",
...
var TodosModle = function () {
    function TodosModle() {
        (0, _classCallCheck3.default)(this, TodosModle);
    ...
    (0, _createClass3.default)(TodosModle, [{
        key: 'getTodos',
        ...
        value: function setTodos(todos) {
            ...
            // sub/pub (观察者模式)
            (0, _Event2.default)(this).fire('change');
        }
    }]);
    return TodosModle;
}();

exports.default = TodosModle;
...
var InputView = function () {
    function InputView(controller) {
        (0, _classCallCheck3.default)(this, InputView);

        this.controller = controller;
        this.init();
    }

    (0, _createClass3.default)(InputView, [{
        key: 'init',
        value: function init() {
            this.creatDom();
            this.bindEvents();
        ...
        value: function creatDom() {
            this.$element = (0, _jquery2.default)('<div>' + '<input type="text" class="input-todo">' + '<button class="new-todo-btn">新增</button>' + '</div>');
            this.inputTodo = this.$element.find('.input-todo');
            this.newTodoBtn = this.$element.find('.new-todo-btn');
            this.$element.appendTo((0, _jquery2.default)('#todo-input'));
        }
    }, {
        key: 'bindEvents',
        value: function bindEvents() {
            ...
            this.newTodoBtn.on('click', function () {
                return _this.handleBtnClick();
            });
        }
    }, {
        key: 'handleBtnClick',
        value: function handleBtnClick() {
            var val = this.inputTodo.val();
            if (!val) {
                return;
            }
            this.inputTodo.val('');
...
var TodoListView = function () {
    ...
    (0, _createClass3.default)(TodoListView, [{
        ...
        key: 'creatDom',
        value: function creatDom() {
            this.$element = (0, _jquery2.default)('<ul></ul>');
            this.creatListDom();
            this.$element.appendTo((0, _jquery2.default)('#todos-list'));
        }
    }, {
        key: 'creatListDom',
        value: function creatListDom() {
            var todos = this.model.getTodos();
            var html = todos.map(function (_ref, key) {
        ...
        value: function bindEvents() {
            ...
            (0, _Event2.default)(this.model).on('change', function () {
                return _this.handleModelChange();
            });
        ...
        key: 'handleListClick',
        value: function handleListClick(event) {
            var $tar = (0, _jquery2.default)(event.currentTarget);
...
var _InputView = __webpack_require__(34);

var _InputView2 = _interopRequireDefault(_InputView);

var _InputController = __webpack_require__(31);

var _InputController2 = _interopRequireDefault(_InputController);

var _TodoListView = __webpack_require__(35);

var _TodoListView2 = _interopRequireDefault(_TodoListView);

var _TodoListController = __webpack_require__(32);
...
var Page = function () {
    function Page() {
        ...
        this.todosModle = new _model2.default();
    }
    ...
    (0, _createClass3.default)(Page, [{
        ...
        key: 'initInputModule',
        value: function initInputModule() {
            this.inputController = new _InputController2.default(this.todosModle);
            this.inputView = new _InputView2.default(this.inputController);
        }
    }, {
        key: 'initTodoListModule',
        value: function initTodoListModule() {
            this.todoListController = new _TodoListController2.default(this.todosModle);
            this.todoListView = new _TodoListView2.default(this.todoListController, this.todosModle);
        }
    }]);
    return Page;
}();
